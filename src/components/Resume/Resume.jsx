    ...
    <section id="resume">
      <div className="container">
        <div className="g_section_title">
          <h2 className="g_title">Resume</h2>
          <p className="g_par">
        ...
        {/* resume sectio's content */}
        <div className="resume_content">
          <div className="resume_content_item_1 resume_content_item">
            <Slide triggerOnce direction="up" duration={1500}>
              <h3 className="resume_title">Sumary</h3>
              <div className="resume_item">
                <h4 className="resume_item_title">ALEX SMITH</h4>
                <p>
                  <em>
              ...
              <div className="resume_item">
                <h4 className="resume_item_title">
          ...
          <div className="resume_content_item_1 resume_content_item">
            <Slide triggerOnce direction="up" duration={1600}>
              <h3 className="resume_title">Professional Experience</h3>
              <div className="resume_item">
                <h4 className="resume_item_title">
              ...
              {/* <h3 className="resume_title">Education</h3> */}
              <div className="resume_item">
                <h4 className="resume_item_title">GRAPHIC DESIGN SPECIALIST</h4>
                <h5>2017 - 2018</h5>
                <p>
